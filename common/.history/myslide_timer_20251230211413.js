$(function () {
  ...
  const slideEl = {
    ...
    speed: 3000,//自動再生スピード
    wait: 800,//スライド待機時間
    picture: true,//sp画像切り替えがある場合、無い時はfalse
      ...
      this.thumb.on('click', (e) => {
        ...
        if (this.click === true) {
          ...
          if (this.picture === true) {
            $('source', this.panelImg).attr('srcset', $('source', imgNum).attr('srcset'));
